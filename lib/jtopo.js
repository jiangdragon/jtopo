            ...
            return {
                ...
                getData: function (b, c) {
                    ...
                    if (a.childs.length > 0) {
                        ...
                        var i = a.getBound(), j = a.canvas.width / a.childs[0].scaleX / i.width;
            ...
            this.initialize = function () {
                ...
                for (var c = 0; c < this.zIndexArray.length; c++)for (var d = this.zIndexArray[c], e = this.zIndexMap[d], f = 0; f < e.length; f++) {
                    ...
                    if (1 == this.paintAll || this.isVisiable(g)) {
                        ...
                        //1 == g.shadow && (b.shadowBlur = g.shadowBlur, b.shadowColor = g.shadowColor, b.shadowOffsetX = g.shadowOffsetX, b.shadowOffsetY = g.shadowOffsetY), g instanceof a.InteractiveElement && (g.selected && 1 == g.showSelected && g.paintSelected(b), 1 == g.isMouseOver && g.paintMouseover(b)),
                        g.paint(b), b.restore()
                    }
                }
...
/****************jTopo.DisplayElement InteractiveElement EditableElement**********************/
    function (a) {
        function b() {
            this.initialize = function () {
...
/****************jTopo.Node TextNode LinkNode CircleNode AnimateNode**********************/
    function (a) {
        function b(c) {
            this.initialize = function (c) {
                ...
                if (null != this.alarm && "" != this.alarm) {
                    ...
                    var d = a.measureText(this.alarm).width + 6, e = a.measureText("鐢�").width + 6, f = this.width / 2 - d / 2, g = -this.height / 2 - e - 8;
                ...
                if (null == a)throw new Error("Node.setImage(): 鍙傛暟Image瀵硅薄涓虹┖!");
                var c = this;
                if ("string" == typeof a) {
                    var d = j[a];
...
/****************jTopo.Link FoldLink FlexionalLink CurveLink**********************/
    function (a) {
        function b(a, b) {
            var c = [];
        ...
        function f(b, c, g) {
            ...
            this.paintText = function (a, b) {
                ...
                if (this.nodeA === this.nodeZ) {
                    var d = this.bundleGap * (this.nodeIndex + 1) / 2, e = a.util.getDistance(this.nodeA, {
                            x: b,
                            y: c
                        }) - d;
                    return Math.abs(e) <= 3
...
/****************jTopo.BarChartNode PieChartNode**********************/
    function (a) {
        function b() {
            ...
            return b.radius = 150, b.colors = ["#3666B0", "#2CA8E0", "#77D1F6"], b.datas = [.3, .3, .4], b.titles = ["A", "B", "C"], b.paint = function (a) {
                ...
                for (var e = 0, f = 0; f < this.datas.length; f++) {
                    ...
                    var h = this.titles[f] + ": " + (100 * this.datas[f]).toFixed(2) + "%", i = a.measureText(h).width, j = (a.measureText("鐢�").width, (e + e + g) / 2), k = this.radius * Math.cos(j), l = this.radius * Math.sin(j);
